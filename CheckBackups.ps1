...
if ($CloudCheck)
{
$web.DownloadString("http://URL/log/backups/$Devicename-CloudBackup/Failure")
}
...
$web.DownloadString("http://URL/log/backups/$Devicename-CloudBackup/Warning")
}
...
$web.DownloadString("http://URL/log/backups/$Devicename-CloudBackup/Success")
}
...
if ($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamBackup/Failure")
}
...
if ($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamBackup/Warning")
}

$VeeamCheckJob = Get-EventLog -Logname "Veeam Backup" -EntryType "Information" -InstanceId 150 -Newest 1 -After (Get-Date).AddHours(-24)
if($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamBackup/Success")
}
...
if ($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamAgent/Failure")
}
...
if ($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamAgent/Warning")
}

$VeeamCheckJob = Get-EventLog -Logname "Veeam Agent" -EntryType "Information" -InstanceId 190 -Newest 1 -After (Get-Date).AddHours(-24)
if($VeeamCheckJob)
{
$web.DownloadString("http://URL/log/backups/$Devicename-VeeamAgent/Success")
}
...
if ($sysrecov)
{
$web.DownloadString("http://URL/log/backups/$Devicename-SystemRecovery/Success")
}
...
if ($sysrecov)
{
$web.DownloadString("http://URL/log/backups/$Devicename-SystemRecovery/Warning")
}
...
if ($sysrecov)
{
$web.DownloadString("http://URL/log/backups/$Devicename-SystemRecovery/Failure")
}
...
if ($backupexecfail)
{
$web.DownloadString("http://URL/log/backups/$Devicename-BackupExec/Failure")
}
...
{
$web.DownloadString("http://URL/log/backups/$Devicename-BackupExec/Warning")
}
...
{
$web.DownloadString("http://URL/log/backups/$Devicename-BackupExec/Success")
}
...
if ($cloudberryfail)
{
$web.DownloadString("http://URL/log/backups/$Devicename-CloudBerry/Failure")
}
...
{
$web.DownloadString("http://URL/log/backups/$Devicename-CloudBerry/Success")
}
